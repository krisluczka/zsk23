/*
	...
	Projekt udostêpniony na licencji OpenSource,
...
namespace zsk23 {
	class interpreter {
		public:
			...
			// g³ówna pêtla intepretera, umo¿liwiaj¹ca kontakt z u¿ytkownikiem
			void main_loop();
		...
		private:
			...
			// kontener na przechowywanie wyra¿eñ
			std::vector<std::string*> expressions;

			// stos programu
			std::stack<int_fast32_t> main_stack;

			// wskaŸnik do pozycji w kodzie
			uint_fast64_t code_position;

			// pseudorejestry do porównywania
