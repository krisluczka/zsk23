...
namespace zsk23 {
	...
	bool interpreter::load_program( std::string path ) {
		...
		while ( std::getline( file, code_line ) ) {
			...
			// komenda wyœwietlaj¹ca znaki ascii
			...
			// komenda porównuj¹ca dwie liczby ze stosu
			...
			// komenda pobieraj¹ca ci¹g znaków od u¿ytkownika
			...
			// komenda pobieraj¹ca liczbê od u¿ytkownika
			...
			// komenda wrzucaj¹ca ci¹g znaków na stos
			...
			// komenda generuj¹ca losow¹ liczbê
			...
			// komenda zwracaj¹ca wielkoœæ stosu
	...
	void interpreter::run_program() {
		...
		// dodatkowe informacje wyœwietlane w trybie debugowania
		if ( debug ) {
		...
		while ( code_position < lines.size() ) {
			...
			// porównuje dwie liczby ze stosu i sprawdza czy s¹ równe
				...
				if ( main_stack.size() > 1 ) {
					...
					// skaczemy o dan¹ iloœæ linijek, je¿eli warunek nie jest spe³niony
					else {
			...
			// porównuje dwie liczby ze stosu i sprawdza czy s¹ starsza jest wiêksza od m³odszej
			...
			// porównuje dwie liczby ze stosu i sprawdza czy s¹ starsza jest mniejsza od m³odszej
			...
			// porównuje dwie liczby ze stosu i sprawdza czy s¹ starsza jest wiêksza lub równa od m³odszej
			...
			// porównuje dwie liczby ze stosu i sprawdza czy s¹ starsza jest mniejsza lub równa od m³odszej
			...
			// porównuje dwie liczby ze stosu i sprawdza czy s¹ starsza jest ró¿na od m³odszej
			...
			// zapêtla kod bloku dan¹ iloœæ razy
			else if ( lines[code_position] == 13 ) {
				if ( arguments[code_position] != -1 ) {
					if ( main_stack.size() > 0 ) {

						// ustawianie parametrów pêtli
						if ( loop_amount == 0 ) {
			...
			// pobiera liczbê od u¿ytkownika i wrzuca na stos
			...
			// kopiuje najm³odsz¹ liczbê stosu
			...
			// losuje liczbê ze wskazanego zakresu
			...
			// odwracanie stosu
				...
				if ( arguments[code_position] != -1 ) {
					...
					for ( uint_fast64_t i = 0; i < max; i++ ) { // aktualizowanie g³ównego stosu
